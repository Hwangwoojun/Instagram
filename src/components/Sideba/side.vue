    ...
    <div v-if="!Login_Register_Page">
      <span class="container">
        <span class="left_panel">
          <h2 class="title">
            <RouterLink to="/home" class="link">Instagram</RouterLink>
          </h2>
          <RouterLink class="img" to="/home">
            <img src="../../../public/assets/house-solid.svg" />
          </RouterLink>
          <h2 class="title_2">
            <RouterLink to="/home" class="link">홈</RouterLink>
          </h2>
